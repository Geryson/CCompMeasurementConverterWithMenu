...
import com.ggantycc.ccompmeasurementconverterwithmenu.viewmodel.TemperatureScreenViewModel

@Composable
fun TemperatureScreen(
    onNavigateToMainMenu: () -> Unit
) {
    val viewModel: TemperatureScreenViewModel = viewModel()
...
fun TemperatureScreenPreview() {
    TemperatureScreen(onNavigateToMainMenu = {})
}
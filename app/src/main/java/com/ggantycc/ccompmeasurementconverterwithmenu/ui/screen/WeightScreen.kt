...
import com.ggantycc.ccompmeasurementconverterwithmenu.viewmodel.WeightScreenViewModel

@Composable
fun WeightScreen(
    onNavigateToMainMenu: () -> Unit
) {
    val viewModel: WeightScreenViewModel = viewModel()
...
fun WeightScreenPreview() {
    WeightScreen(onNavigateToMainMenu = {})
}